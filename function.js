...
for (x=0; x<95; x++){
    ...
    switch(SETS){
        case 1:
            ...
            var image = $("<img></img>").attr("src",oop[num])
            $('#facts').append(image)
            SETS=2
            break
        case 2:
            var num2 = Math.floor(Math.random() * (oop2.length));
            var image = $("<img></img>").attr("src",oop2[num])
            $('#facts').append(image)
            SETS=3
            break
        case 3:
            var num3 = Math.floor(Math.random() * (oop3.length));
            var image = $("<img></img>").attr("src",oop3[num])
            $('#facts').append(image)
            SETS=1
            break
...
var message = ['1123', "3546", '565465' ,'6755', '547576', '6768', '7688'];
var mess = message[Math.floor(Math.random() * (message.length))];
/* var message = ("8879") */
$(".code").text(`${mess}`);
